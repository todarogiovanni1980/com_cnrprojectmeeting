...
/**
 * View class for a list of Cnrprojectmeeting.
 *
 * @since  1.6
 */
class CnrprojectmeetingViewMeetings extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CnrprojectmeetingHelper::addSubmenu('meetings');
	...
	protected function addToolbar()
	{
		...
		$canDo = CnrprojectmeetingHelper::getActions();

		JToolBarHelper::title(JText::_('COM_CNRPROJECTMEETING_TITLE_MEETINGS'), 'meetings.png');
		...
		{
			JToolBarHelper::preferences('com_cnrprojectmeeting');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_cnrprojectmeeting&view=meetings');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_CNRPROJECTMEETING_MEETINGS_TITLE'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`startdate`' => JText::_('COM_CNRPROJECTMEETING_MEETINGS_STARTDATE'),
			'a.`enddate`' => JText::_('COM_CNRPROJECTMEETING_MEETINGS_ENDDATE'),
			'a.`host`' => JText::_('COM_CNRPROJECTMEETING_MEETINGS_HOST'),
			'a.`location`' => JText::_('COM_CNRPROJECTMEETING_MEETINGS_LOCATION'),
		);
	}
